...
7. Zugriff vom iPhone
    ...
    * Öffne die Nextcloud App und gehe zu den Einstellungen: Tippe auf das Menü-Symbol (oben links in der App). Wähle Einstellungen aus.
    * Aktivierung des automatischen Foto-Uploads: Wähle „Automatischer Foto-Upload“ aus den Einstellungen.
    * Wählen des Ordners für den Upload:
...
## Mounting mit SSD externer Festplatte

> [!NOTE]
> Die SSD muss ein Dateisystem wie ext4 verwenden, das von Linux unterstützt wird.
> Formatieren die SSD auf ext4:: sudo mkfs.ext4 /dev/sda1
